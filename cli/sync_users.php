 ...
 * Sample cron entry:
 * # 5 minutes past 4am
 * 5 4 * * * sudo -u www-data /usr/bin/php /var/www/moodle/auth/db_salt/cli/sync_users.php
 *
 * Notes:
...
The auth_db_salt plugin must be enabled and properly configured.
...
Example:
\$ sudo -u www-data /usr/bin/php auth/db_salt/cli/sync_users.php
...
if (!is_enabled_auth('db_salt')) {
    cli_error('auth_db_salt plugin is disabled, synchronisation stopped', 2);
}
...
$dbauth = get_auth_plugin('db_salt');
